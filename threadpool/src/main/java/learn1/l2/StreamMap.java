...
public class StreamMap {
    ...
    public static void main(String[] args) {
        ...
        map.values().stream().flatMap(Collection::parallelStream).collect(Collectors.toList());

        //H,e,l,l,o,W,o,r,l,d
       // Stream<String> stringStream = stream.flatMap( e Arrays::stream);
        //把里面的流合并在一起，形成一个新的流
        Stream<String> stringStream = stream.flatMap(e-> Arrays.stream(e));
