...
/***************************************
进行一些聚合的操作，或者是分组的操作，主要实现Collector接口
 ***************************************/
...
/*
    ...
    private static void testGroupingByFunction() {
        ...
        final Map<Dish.Type, List<Dish>> collect = menu.stream().collect(Collectors.groupingBy(Dish::getType));
    ...
    private static void testGroupingByFunctionAndCollector() {
        ...
        Optional.ofNullable(new Apple()).map(Apple::getColor).orElse("aa");
    }
