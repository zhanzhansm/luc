...
public class OptionalUsage {
    ...
    public static void main(String[] args) {
        ...
        Optional<Insurance> insuranceOptional1 = Optional.of(null);
        ...
        Insurance insurance = insuranceOptional1.filter(i -> i.getName() != null).orElseGet(Insurance::new);
